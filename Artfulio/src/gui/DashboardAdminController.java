...
public class DashboardAdminController implements Initializable {
    ...
    public ObservableList<User> getUserList() {
        ...
        try {
            ...
            while (rs.next()) {
                User user = new User(rs.getInt("id_user"), rs.getString("username"), rs.getString("cin_user"), rs.getString("adresse_user"), rs.getString("password_user"), rs.getString("email_user"), rs.getString("type_role"), rs.getBoolean("is_pro"));
                UserList.add(user);
            }
    ...
    private void ModifierU(MouseEvent event) throws IOException {
        ...
        GoPage("/gui/ModifierUser.fxml", event);
        FXMLLoader loader = new FXMLLoader();
