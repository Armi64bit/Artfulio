...
private static Message prepareMessagemdp(Session session, String username,String destinataire) throws MessagingException {
    UserService us= new UserService();    
    User u=us.afficherparmail(destinataire);
...
public static void envoyermdp(String destinataire) throws MessagingException {
...
//            String password ="hxdhgdtthfmjqqfj";
            ...
            Message message = prepareMessagemdp(session,username,destinataire);
            Transport.send(message);
            System.out.println("Message envoyé !!");
}
}
